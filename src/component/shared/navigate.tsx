...
export const Navigate: React.FC<Props> = ({ className }: Props) => {
    return (
        <div className={cn('fixed z-20 flex gap-2 left-1/2 bottom-2 -translate-x-1/2 bg-color-dark p-2 rounded-md transition03 hover:pt-3', className)}>
            ...
            <NavigateButton link='/profile/1' path='/icon/human.svg' />
