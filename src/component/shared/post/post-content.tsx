...
export const PostContent: React.FC<Props> = ({ }: Props) => {
    return (
        <>
            ...
            <ViewAuthor>
                {/* @ts-ignore */}
                <Modal.Set modal={Modal.AccessAction} fn={() => console.log('zxc')} warning={"Вы собираетесь удалить проект?"} warningButtonText={'Удалить пост'}>
                    <Button variant="reject" className="my-2">Удалить пост</Button></Modal.Set></ViewAuthor>
            <PostInfo />
            <MainBlock />
            <CommentBlock />
        </>
