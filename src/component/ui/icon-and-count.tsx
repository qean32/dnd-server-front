...
export const IconAndCount: React.FC<Props> = ({ className, iconAction, icon, count, action }: Props) => {
    ...
    return (
        <div className={cn('overflow-hidden py-5 flex gap-2 h-[30px] bg-color-light-hover transition03 p-2 cursor-pointer items-center rounded-2xl', className)} onClick={clickHandler}>
