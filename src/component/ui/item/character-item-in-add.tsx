...
export const CharacterItemInAdd: React.FC<Props> = ({ id, name, discription, path = '/img/entity.jpg' }: Props) => {
    return (
        <div data={JSON.stringify({ id, name, discription, path })}
            className='prime-hover relative overflow-hidden rounded-sm running-line-parent h-[100px] cursor-pointer bg-color-dark-hover transition-03 bg-img hover:-translate-y-2'>
